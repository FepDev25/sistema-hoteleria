...
-- AUDITOR: sin esto, updated_at nunca se actualiza automáticamente.
...
-- AUDITOR: la PK cubre (room_type_id, amenity_id) pero no la dirección inversa.
...
-- AUDITOR: idx_guests_email eliminado — el UNIQUE constraint ya crea su propio índice.
...
-- AUDITOR: Prevención de doble reserva de habitación.
...
CREATE TABLE invoices (
    ...
    -- AUDITOR: issued_at es obligatorio en cualquier estado distinto a DRAFT
    ...
    -- AUDITOR: paid_at es obligatorio cuando la factura está pagada
...
-- AUDITOR: idx_invoices_reservation_id eliminado — el UNIQUE constraint ya crea su propio índice.
...
CREATE TABLE payments (
    ...
    -- AUDITOR: paid_at obligatorio cuando el pago fue completado
...
-- AUDITOR: idx_employees_email eliminado — el UNIQUE constraint ya crea su propio índice.
...
-- AUDITOR: Prevenir reseñas en reservas no completadas.
